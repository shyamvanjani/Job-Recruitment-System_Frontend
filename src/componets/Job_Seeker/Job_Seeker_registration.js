...
return(<><div className="login-div">
    ...
    <form onSubmit={btnclick}>
            <div className="input-div">
                ...
                <div className="input-bx" style={{marginLeft:"29px"}}>
           ...
           <div className="input-div">
                ...
                <select className="input-bx" value={selectedOption} onChange={handleOptionChange} style={{height:"50px",borderColor:"#007bff",borderRadius: "5px",marginLeft:"15px"}} required>
        ...
        <option value="Biomedical Engineering">Biomedical  Engineering</option>
           ...
           <div className="input-div" >
                ...
                <select className="input-bx" value={selectedField} onChange={handleFieldChange} style={{height:"50px",borderColor:"#007bff",borderRadius: "5px",marginLeft:"15px"}} required>
