...
export default function Job_Seeker_Profile(props) {
    return (<><section className="h-100 gradient-custom-2" style={{ marginLeft: "245px",marginBottom:"30px" }}>
                    ...
                    <div className="card" style={{ width: "700px" }}>
                        <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: "#007bff", height: "200px" }}>
                            <div className="ms-4 mt-5 d-flex flex-column" style={{ width: "150px" }}>
                                <img src={props.user.image}
                                    alt="Generic placeholder image" className="w-100 rounded-3"
                        ...
                        <div className="card-body p-4 text-black">
                            ...
                            <div className="mb-5">
                                ...
                                <div className="p-4" style={{ backgroundColor: "#f8f9fa" }}>
                                <img src={props.user.resume} className="w-100 rounded-3"/>
                                </div>
